...
const images = [
  '/img/largebreed/Husky.jpg',
  '/img/largebreed/Labrador.jpg',
  '/img/largebreed/GermanShepherd.jpg',
  '/img/largebreed/Boxer.jpg',
  '/img/largebreed/GoldenRetriever.jpg'
];
...
const LargeSlider = () => {
  ...
  return (
    <div className="relative w-[90vw] h-[50vw] sm:w-[80vw] sm:h-[40vw] md:w-[90vw] md:h-[35vw] lg:w-[90vw] lg:h-[35vw] lg:mb-5 overflow-hidden mx-auto">
