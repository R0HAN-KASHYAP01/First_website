      ...
      <div className="mt-4">
        {activeTab === 'details' && (
          <div className='flex flex-col gap-5'>
            ...
            <p><strong>Color(s):</strong> Any true hound color (Tricolor).
            </p>
            <p><strong>Coat:</strong> Beagles have a very sleek and shorthaired coat. The Beagle has a hound type coat of medium length making grooming relatively easy for this breed.
            </p>
