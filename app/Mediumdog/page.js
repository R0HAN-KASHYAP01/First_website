...
import ImageSlider3 from './Medium_Slider';
...
const DogArray = [
  ...
  { img: "/img/Mediumbreed/ChowChow.jpg", Name: "Chow Chow", path: "/Mediumdog/ChowChow" },
  { img: "/img/Mediumbreed/Dachshund.jpg", Name: "Dachshund", path: "/Mediumdog/Dachshund" }
];
